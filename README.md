# Secure and Correct Inference (SCI) Library for Transformer Based Large-scale Model

## Introduction
 This directory contains the code for the Secure and Correct Inference (SCI) library from ["SecureFormer"](https://google.com)<!--(https://eprint.iacr.org/2020/1002) -->
